...
import CloserEvolutionChart from '../components/CloserEvolutionChart'; // Importa o novo componente
import { FileText, FileCheck, DollarSign, Handshake } from 'lucide-react';
    ...
    <div className="space-y-8">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <KpiCard title="COFs Assinadas" value={cofAssinadas} color="blue" small />
      ...
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <KpiCard title="COF Enviada > COF Assinada" value={taxaAssinaturaCof} unit="%" icon={<FileCheck />} color="blue" />
