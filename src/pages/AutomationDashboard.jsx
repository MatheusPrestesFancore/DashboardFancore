...
const AutomationDashboard = ({ data }) => {
  ...
  // Todos os cálculos agora usam 'automationLeads' em vez de 'data'
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <KpiCard title="Taxa de Resposta (Aut.)" value={taxaResposta} unit="%" icon={<MessageSquare />} color="blue" />
        <KpiCard title="Taxa de Interesse (Aut.)" value={taxaInteresse} unit="%" icon={<TrendingUp />} color="yellow" />
      </div>
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={funnelData} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <YAxis type="category" dataKey="name" stroke="#A0AEC0" width={140} />
